...
exports.onHazardStatusUpdated = exports.onSosTriggered = exports.onHazardCreated = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
const hazardAggregator_1 = require("./ai/hazardAggregator");
 ...
 */
exports.onHazardCreated = functions.firestore
    ...
    try {
        ...
        const aiAnalysis = await (0, hazardAggregator_1.runHazardAggregatorAi)(rawInput, existingReports);
 ...
 */
exports.onHazardStatusUpdated = functions.firestore
    .document("hazards/{hazardId}")
